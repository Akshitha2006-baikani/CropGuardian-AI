const I18nModule = (function() {
  const translations = {
    en: {
      ...
      phrases: {
        'Language': 'Language', 'Select language': 'Select language', 'Sign in': 'Sign in', 'Sign out': 'Sign out',
        ...
        'Welcome back': 'Welcome back', 'Your farm workspace': 'Your farm workspace', 'Sign in to access your saved crop history and assistant conversations.': 'Sign in to access your saved crop history and assistant conversations.',
        'Remember me on this device': 'Remember me on this device', 'New to CropGuardian?': 'New to CropGuardian?', 'Create an account': 'Create an account', 'Continue without signing in': 'Continue without signing in',
        ...
        'Sign in to your account': 'Sign in to your account', 'Create account': 'Create account', 'Sign in': 'Sign in', 'Speaking...': 'Speaking...',
    ...
    te: {
      ...
      phrases: {
        'Language': 'భాష', 'Select language': 'భాషను ఎంచుకోండి', 'Sign in': 'ప్రవేశించండి', 'Sign out': 'నిష్క్రమించండి', 'Farm profile': 'వ్యవసాయ ప్రొఫైల్',
        ...
        'Welcome back': 'తిరిగి స్వాగతం', 'Your farm workspace': 'మీ వ్యవసాయ కార్యస్థలం', 'Sign in to access your saved crop history and assistant conversations.': 'సేవ్ చేసిన పంట చరిత్ర, సహాయకుడితో సంభాషణల కోసం ప్రవేశించండి.', 'Remember me on this device': 'ఈ పరికరంలో నన్ను గుర్తుంచుకోండి', 'New to CropGuardian?': 'CropGuardian‌కు కొత్తవారా?', 'Create an account': 'ఖాతా సృష్టించండి', 'Continue without signing in': 'ప్రవేశించకుండా కొనసాగండి',
